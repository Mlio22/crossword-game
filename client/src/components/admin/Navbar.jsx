...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 h-16">
              ...
              <div className="flex items-center ml-3">
                ...
                >
                  ...
                  <ul className="py-1" role="none">
                    {/* todo: tidak bisa tekan tombol akun ketika ter-redirect dari login */}
